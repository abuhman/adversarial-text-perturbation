#########################################################
# Data helpers for reading files for text classification
#
...
def get_datasets_dbpedia(data_file, limit):
    """
    Loads dbpedia data from files up tp limit entries in each category, 
