#########################################################
# Slightly modified version of original code from github 
# for evaluating test examples using text classifier trained 
# using train.py
#
...
class flagClass():
    batch_size = 64
    checkpoint_dir = '/home/cmanticuno/pdghcc/cnn-text-classification-tf/runs/1526063433/'
    eval_train = True
...
checkpoint_path = '/home/cmanticuno/pdghcc/cnn-text-classification-tf/runs/1526063433/checkpoints/'
